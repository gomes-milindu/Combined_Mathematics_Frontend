  ...
  return (
    <>
      <section className="relative w-full h-auto">
        ...
        <div
          className="w-full h-[60px] md:h-[115px] bg-cover bg-no-repeat relative"
          style={{ backgroundImage: `url('https://afablbkjnkbxwieszbtb.supabase.co/storage/v1/object/public/HomePage/Rectangle%206.png')` }}
        >
          <div
            className="w-full h-full bg-cover absolute z-1 bg-no-repeat right-0 top-0"
            style={{ backgroundImage: `url('https://afablbkjnkbxwieszbtb.supabase.co/storage/v1/object/public/HomePage/Rectangle%207.png')` }}
          ></div>
        </div>
          ...
          <div className="block md:hidden px-6 py-8">
            ...
            <div className="flex flex-col items-center mb-8">
              <div
                ...
                style={{ backgroundImage: `url('https://afablbkjnkbxwieszbtb.supabase.co/storage/v1/object/public/HomePage/name.png')` }}
              ></div>
                ...
                <div className="flex flex-col gap-2 text-[11px]">
                  <div className="flex flex-row items-center gap-2">
                    <div
                      ...
                      style={{ backgroundImage: `url('https://afablbkjnkbxwieszbtb.supabase.co/storage/v1/object/public/HomePage/mail.png')` }}
                    ></div>
                  ...
                  <div className="flex flex-row items-center gap-2">
                    <div
                      className="w-[18px] h-[15px] bg-contain bg-no-repeat bg-center shrink-0"
                      style={{ backgroundImage: `url('https://afablbkjnkbxwieszbtb.supabase.co/storage/v1/object/public/HomePage/call.png')` }}
                    ></div>
                  ...
                  <div className="flex flex-row items-center gap-2">
                    <div
                      className="w-[18px] h-[15px] bg-contain bg-no-repeat bg-center shrink-0"
                      style={{ backgroundImage: `url('https://afablbkjnkbxwieszbtb.supabase.co/storage/v1/object/public/HomePage/map.png')` }}
                    ></div>
