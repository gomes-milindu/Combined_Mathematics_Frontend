  ...
  return (
    ...
    <>
      ...
      <main className="w-full flex justify-center items-end">
          ...
          {/* Main Form Card */}
          <div className="h-[85vh] w-[80%] rounded-2xl border flex flex-col justify-center items-center shadow-2xl  border-purple-400">
            <div className=" w-[90%] h-[95%] flex flex-col justify-center items-center">
              <div className="grid grid-cols-2 w-full h-full gap-5">
                ...
                {/* First Name */}
                <div className="space-y-2 group flex flex-col gap-3">
                  <label className="flex items-center text-sm font-semibold text-gray-700 group-hover:text-purple-600 transition-colors gap-2">
                ...
                {/* Last Name */}
                <div className="space-y-2 group flex flex-col gap-3">
                  <label className="flex items-center text-sm font-semibold text-gray-700 group-hover:text-cyan-600 transition-colors gap-2">
              ...
              <div className=" flex flex-col sm:flex-row gap-4 justify-end">
                <button
                  type="button"
                  className="w-20 h-10 bg-purple-200 rounded-2xl"
                >
                  Cancel
                </button>
                <button
                  onClick={Create}
                  className="w-30 h-10 bg-purple-200 rounded-2xl"
                >
                  Create Student
                </button>
              </div>
